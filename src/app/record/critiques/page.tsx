...
import {
  RECORD_PAGE_SIZE,
  countCritiqueRecordsPage,
  fetchCritiqueRecordsPage,
...
export default function CritiquesPage() {
  ...
  const countQuery = useQuery({
    queryKey: queryKeys.record.contentCount(userUid!, "critique", scopeKey),
    queryFn: () =>
      countCritiqueRecordsPage({
        userUid: userUid!,
        showOnlyMine,
  ...
  const recordsQuery = useQuery({
    ...
    queryFn: async () => {
      ...
      for (let p = 1; p < currentPage; p++) {
        const batch = await fetchCritiqueRecordsPage({
          userUid: userUid!,
          showOnlyMine,
          bookId: selectedBookId || undefined,
          searchQuery,
      ...
      return fetchCritiqueRecordsPage({
        userUid: userUid!,
        showOnlyMine,
        bookId: selectedBookId || undefined,
        searchQuery,
