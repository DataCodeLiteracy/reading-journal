        ...
        <div className='p-6 overflow-y-auto max-h-[60vh]'>
          <div className='space-y-4'>
            {checklist.map((item, index) => (
              <div
                key={item.id}
                className='flex items-start gap-3 p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors cursor-pointer'
